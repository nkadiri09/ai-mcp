...
# installed.
TK_PREFIX='/Users/nkadiri/Documents/project/ai-learning/python-test/venv'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/nkadiri/Documents/project/ai-learning/python-test/venv'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/nkadiri/Documents/project/ai-learning/python-test/venv/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/nkadiri/Documents/project/ai-learning/python-test/venv/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/nkadiri/Documents/project/ai-learning/python-test/venv/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/Users/nkadiri/Documents/project/ai-learning/python-test/venv/lib/libtkstub8.6.a'
